  ...
  <div class="login-wrap">
    <div class="login">
      ...
      <div class="login-model">
        <div class="content">
          <div class="text-center text-2xl font-semibold mb-5">企业微信会话存档系统</div>
            ...
            <el-tabs id="login-tab" v-model="activeTab" @tab-click="handleTabClick">
              ...
              <el-tab-pane label="账号登录" name="password">
                <el-form-item label="" prop="code">
                  <el-input v-model="loginForm.code" type="text" placeholder="请输入帐号">
                    <template #prefix>
...
export default defineComponent({
  setup() {
    ...
    const formRules = reactive<FormRules>({
      ...
      code: [{ required: true, message: '请输入帐号', trigger: 'blur' }]
    })
